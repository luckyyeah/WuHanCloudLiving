	...
	public String getPageStr() {
		...
		if(totalResult>0){
			...
			if(currentPage==1){
				...
				sb.append("	<li><input type=\"number\" value=\"\" id=\"toGoPage\"  style=\"width:50px;height:28px;text-align:center;float:left\" placeholder=\"页码\"/></li>\n");
			...
			sb.append("	<li><select id='showCount' name='showCount' title='显示条数'  style=\"width:55px;height:28px;float:left;\" onchange=\"changeCount(this.value)\">\n");
